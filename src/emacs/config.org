...
(use-package web-mode
  ...
  (setq web-mode-content-types-alist
        '(("jsx" . "\\.js[x]?\\'")))
  (add-to-list 'eglot-server-programs '((javascript-mode js2-mode) . ("javascript-typescript-stdio"))))
...
(use-package treemacs
  ...
  (with-eval-after-load 'winum
    (define-key winum-keymap (kbd "M-l") #'treemacs-select-window))
  :config
  (progn
    (setq
         treemacs-width 35
