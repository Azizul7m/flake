...
(use-package lspce
  :load-path "~/.config/emacs/site-lisp/lspce"
  :after markdown-mode
  :config (progn
            ...
            (setq lspce-server-programs `(
                                          ...
                                          ("typescript-ts-mode" "typescript-language-serve --stdio" )
                                          ("javascript-mode" "typescript-language-serve --stdio" )
                                          ("web-mode" "typescript-language-serve --stdio" )
                                          ("python" "pylsp" "" )
...
;;   :ensure t
;;   :hook ( tsx-ts-mode . (lambda 'eglot-ensure))
;;   :mode (("\\.ts\\'" . (tsx-ts-mode))))

;; (use-package tsx-ts-mode
;;   :ensure nil
;;   :config (emmet-mode 1)
;;   :hook ( tsx-ts-mode-hook . (lambda 'eglot-ensure))
;;   :mode (("\\.tsx\\'" . (lambda tsx-ts-mode))))



;; (use-package projectile-lint
;;   :ensure t
;;   :defer t)

;;(projectile-lint-add-linters '("eslint" "typescript"))
#+end_src
