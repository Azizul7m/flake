...
(use-package cape
  ...
  :config
    ...
    (advice-add 'lsp-completion-at-point :around #'cape-wrap-super)
...
(use-package lsp-mode
  :ensure t)
(setq lsp-company-backend 'corfu)
...
(use-package typescript-mode
    ...
    :mode "\\.ts\\'"
    :config
    (setq-default typescript-lsp-extra-server-flags "--log-level=verbose"))
...
(add-hook 'solidity-mode-hook 'lsp-mode)
#+end_src
*** tailwind
