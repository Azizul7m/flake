...
(use-package typescript-ts-mode
  ...
  :hook ( 'typescript-ts-mode . '(eglot-ensure npm-mode))
  :config
...
(use-package elfeed-webkit
  :straight (elfeed-webkit :type git :host github :repo "fritzgrabo/elfeed-webkit"))

(use-package elfeed-dashboard
  :straight (elfeed-dashboard :type git :host github :repo "manojm321/elfeed-dashboard"))
