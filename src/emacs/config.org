...
(gptel-make-openai "TogetherAI"         ;Any name you want
  ...
  :key "034dc79db5eb2889e37553de64645e3fb3e7b9261d80e1dcf6c6c5f11acd909c"                   ;can be a function that returns the key
  :stream t
...
;;  Use Apheleia on Org Source Blocks
(add-hook 'org-src-mode-hook (lambda () (add-hook 'before-save-hook #'apheleia-format-buffer nil t)))
