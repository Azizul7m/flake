...
;;   :config
;;     (setq eglot-enable-auto-start t)
;;   :init
;;     (setq eglot-corfu-backend t))
(with-eval-after-load 'eglot
    (add-to-list 'eglot-server-programs '(
                ((typescript-mode tsx-mode javascript-mode) . ("typescript-language-server" "--stdio"))
...
;; Hook to enable visual fill column mode
(add-hook 'org-mode-hook
            (lambda ()
            (visual-fill-column-mode t))))
#+end_src
